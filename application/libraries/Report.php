...
class report {
	...
	public function showReport($path, $reportAsal, $reportTujuan, $params='', $type=1) {
		...
		if ($type == 1) {
			...
			$htmlExporter->setParameter($htmlExporterHtml->IS_USING_IMAGES_TO_ALIGN, true); 	
			$htmlExporter->setParameter($htmlExporterHtml->IMAGES_URI, "localhost/sap_erp/modules/sales/laporan/".$folder[0].".html_files/");
