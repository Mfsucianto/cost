...
<!-- Main content -->
<section class="content" id="sec_anggaran" >

    <!-- Default box -->
    <div class="box">
        <div class="box-header with-border">
            <h3 class="box-title">Monitoring Anggaran</h3>
                                ...
                                <div class="input-group input-group-sm" style="width: 140px;">
                                    '.$cb.'
                                        <span class="input-group-btn">
                                          <button type="button" onclick="searchanggaran()"  class="btn btn-info btn-flat" ><i class="fa fa-search" ></i> Cari</button>
                                        </span>
                                </div>
...
<!-- ==============================================end of section monitoring anggaran============================================ -->
...
<script type="text/javascript">
   ...
   function searchanggaran() {
    ...
    function loadData(){
        ...
        var url = "<?php echo site_url().'/monitoring_anggaran/getData'; ?>";
        return $.ajax({
            type: 'POST',
            data: 'cTahun='+cTahun, 
            url: url,
